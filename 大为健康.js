...
var headers = {
    ...
    'Cookie': 's342b0066=gt0hus3ttcrtscht3d47rfvr5e'
}
...
async function login() {
    ...
    try {
        ...
        if (code == 1) {
            ...
            let code2 = response_data2.code
        if (code2 === 1) {
            if (Array.isArray(response_data2.datilist)) {
                let filteredData = response_data2.datilist.filter(item => {
                    return item.huodong && item.huodong.title.includes('人生故事') && item.hongbao_str === '红包已发放';
                });
                count_money_num2 = filteredData.length;
                // count_money_num2 = response_data2.datilist.length
            }
            ...
            if(count_money_num != count_money_num2){
                count_money_num = count_money_num2
            }
            // console.log(count_money_num+'==='+count_money_num2)
            // return
